...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'ime' => [
        'regex' => 'Ime može da sadrži samo slova.',
    ],
      'name' => [
        'regex' => 'Polje ime i prezime može da sadrži samo slova.',
    ],
    'telefon' => [
        'regex' => 'Polje telefon može da sadrži samo brojeve i znakove - /',
    ],
    'komentar' => [
        'regex' => 'Komentar može da sadrži samo slova, brojeve i znakove .!?,:;.',
    ],
    'adresa' => [
        'required' => 'Adresa je obavezna!',
        'regex' => 'Adresa može da sadrži samo slova i znakove - /',
    ],
    'poruka' => [
        'required' => 'Napišite poruku.',
        'regex' => 'Poruka može da sadrži samo slova, brojeve i znakove .!?,:;',
    ],
      'product' => [
        'required' => 'Niste ništa naručili.',
    ], 
    ],
